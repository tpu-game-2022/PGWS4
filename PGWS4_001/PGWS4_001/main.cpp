...
result = texbuff->WriteToSubresource(0, nullptr, texturedata.data(), sizeof(TexRGBA) * 256, sizeof(TexRGBA) * (UINT)texturedata.size());
...
while (true)
{
	...
	_cmdList->DrawIndexedInstanced(6/*27*/, 1, 0, 0, 0);
